...
#include<math.h>
void main(){
int a[50][50],b[50][50],subs[50][50],mul[50][50],r1,c1,r2,c2,add[50][50],trace=0,trace2=0,flag=1,count=0,count1=0,a1,b1,a2,b2,copyarr[50][50],sum=0,evecount=0,oddcount=0;
...
printf("Arranging the rows in ascending order of matrix a");
 for(int i=0;i<r1;i++)
                ...
                printf("The sum of the elements of each  row are  ");
...
printf("\n");
                printf("The sum of elements of each column are ");
                 ...
                 for(int j=0;j<c1;j++)
                {
                    ...
                    printf("\n The sum of %d column is %d",j+1,sum);
                    sum=0;

                }

printf("\n");
printf("Frequency of odd and even number in a matrix");
                ...
                printf("\nThe no of even no of elements in  matrix is %d ",evecount);
                printf("\nThe no of odd no of elements in matrix is %d",oddcount);
