...
#include <conio.h>
#include <malloc.h>
struct node                                         // option 1 is not executed perfectly
{
    int data;
    struct node *next;
           ...
           struct node *display(struct node*start)
           {
              ...
              struct node *insert_end(struct node *start)
              {
                 ...
                 struct node *insert_before(struct node *start)
                 {
                   ...
                   printf("\n Enter the data");
                   scanf("%d",&num);
                   printf("\n Enter teh value before which the data has to be inserted : ");
                   scanf("%d",&val);
                    new_node=(struct node*)malloc(sizeof(struct node));
                  new_node->data=num;
                 ptr=start;
                ...
                struct node *delete_beg(struct node*start)
                {
                  ...
                  struct node *delete_end(struct node* start)
                  {
                    ...
                    struct node *delete_node(struct node *start)
                    {
                        ...
                        int value;
                        printf("\n Enter the value ofthe node which has to be deleted");
                        scanf("%d",&value);
                        ptr=start;
                        if(ptr->data==value)
                        {
