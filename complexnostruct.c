    ...
    do{
                 ...
                 printf("\n 4. Substrct the cmplex numbers");
                  printf("\n 5. Exit");
                   printf("\n Enter your option");
                     ...
                     {
            case 1:
                         printf("\n Enter the real and complex part of the first complex number : ");
                         scanf("%d,%d",&c1.real,&c1.imag);
                         printf("\n Enter the real and complex part of the second complex number : ");
            ...
            case 3:
             ...
             case 4:
                         ...
                         printf("\n The substraction of two complex numbers is : %d+%di",sub_c.real,sub_c.imag);
                          break;
                     }
                          }while(option!=5);
                          getch();
